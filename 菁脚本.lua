...
local Window = OrionLib:MakeWindow({Name = "菁脚本", HidePremium = false, SaveConfig = true,IntroText = "菁脚本", ConfigFolder = "菁脚本"})

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "菁脚本"; Text ="欢迎使用菁脚本"; Duration = 4; })
...
about:AddParagraph("作者: Hfh916")
about:AddParagraph("作者qq: 1357377308")
about:AddParagraph("qq群: 没有")
